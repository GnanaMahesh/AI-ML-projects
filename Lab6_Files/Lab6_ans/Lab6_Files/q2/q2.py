...
class SKLearnDecisionTree:
    ...
    def train_model(self, criterion="entropy"):
        ...
        train_accuracy = metrics.accuracy_score(self.Y_train, train_preds)
        test_accuracy = metrics.accuracy_score(self.Y_test, test_preds)
        train_f1 = metrics.f1_score(self.Y_train, train_preds)
        test_f1 = metrics.f1_score(self.Y_test, test_preds)
        results = {
        ...
        for max_depth in range(1, 11):
            for min_samples_split in range(3, 31, 3):
                for min_samples_leaf in range(1, 11):
                    clf = DecisionTreeClassifier(random_state= 42, criterion=criterion,max_depth=max_depth,
